...
- [fix] A layer moved between documents differing in bit depth, or between a
  PSD and a PSB, is re-encoded for the destination instead of being carried
  across in the source's packing, which read back black (#867)
