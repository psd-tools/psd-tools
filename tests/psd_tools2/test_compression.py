...
import pytest
import logging
from psd_tools2.compression import (
...
@pytest.mark.parametrize('fixture, width, height, depth, version', [
...
@pytest.mark.parametrize('data, kind, width, height, depth, version', [
